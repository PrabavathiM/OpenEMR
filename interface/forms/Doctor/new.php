...
<html>
    <head>
        <title><?php echo xlt("Doctor Instructions"); ?></title>
    ...
    <body>
        <div class="container mt-3">
            <div class="row">
                <div class="col-12">
                    <h2><?php echo xlt('Doctor Instructions'); ?></h2>
                    <form method="post" name="my_form" action="<?php echo $rootdir; ?>/forms/Doctor/save.php?id=<?php echo attr_url($formid); ?>">
